...
def init_config(conf):
    global KEY, CLEANUP_PERIOD, CONVERT_VIDEO_PERIOD, AUDIO_EXPIRATION_TIME, PLAYLIST_EXPIRATION_TIME, HTTP_PROXY, HTTPS_PROXY, PROXIES, USE_OAUTH, COOKIES_FILE_PATH, AUDIO_DIR, HL, MARK_WATCHED
